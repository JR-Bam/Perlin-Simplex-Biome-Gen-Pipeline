...
@export_range(0.0, 1.0, 0.01) var grassland_p_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var savanna_p_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var tundra_e_min: float = 0.2
...
@export_range(0.0, 1.0, 0.01) var boreal_forest_t_min: float = 0.35
@export_range(0.0, 1.0, 0.01) var boreal_forest_t_max: float = 0.5
@export_range(0.0, 1.0, 0.01) var boreal_forest_p_min: float = 0.0
...
@export_range(0.0, 1.0, 0.01) var alpine_tundra_t_max: float = 0.35
