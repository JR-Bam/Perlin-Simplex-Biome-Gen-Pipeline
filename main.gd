...
@export_range(0.0, 1.0, 0.01) var desert_p_max: float = 0.3
@export_range(0.0, 1.0, 0.01) var desert_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var desert_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var grassland_t_max: float = 0.7
@export_range(0.0, 1.0, 0.01) var grassland_p_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var grassland_p_max: float = 0.6
@export_range(0.0, 1.0, 0.01) var grassland_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var grassland_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var savanna_t_min: float = 0.5
@export_range(0.0, 1.0, 0.01) var savanna_t_max: float = 1.0
@export_range(0.0, 1.0, 0.01) var savanna_p_min: float = 0.3
@export_range(0.0, 1.0, 0.01) var savanna_p_max: float = 0.8
@export_range(0.0, 1.0, 0.01) var savanna_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var savanna_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var tundra_t_max: float = 0.3
@export_range(0.0, 1.0, 0.01) var tundra_p_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var tundra_p_max: float = 1.0
@export_range(0.0, 1.0, 0.01) var tundra_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var tundra_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var boreal_forest_t_min: float = 0.15
@export_range(0.0, 1.0, 0.01) var boreal_forest_t_max: float = 0.5
@export_range(0.0, 1.0, 0.01) var boreal_forest_p_min: float = 0.2
@export_range(0.0, 1.0, 0.01) var boreal_forest_p_max: float = 1.0
@export_range(0.0, 1.0, 0.01) var boreal_forest_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var boreal_forest_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var temperate_forest_t_max: float = 0.65
...
@export_range(0.0, 1.0, 0.01) var temperate_forest_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var temperate_forest_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var woodland_t_max: float = 0.75
@export_range(0.0, 1.0, 0.01) var woodland_p_min: float = 0.1
@export_range(0.0, 1.0, 0.01) var woodland_p_max: float = 0.7
@export_range(0.0, 1.0, 0.01) var woodland_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var woodland_h_max: float = 1.0
...
@export_range(0.0, 1.0, 0.01) var rainforest_h_min: float = 0.0
@export_range(0.0, 1.0, 0.01) var rainforest_h_max: float = 1.0

@export_group("Mountain Thresholds")
@export_range(0.0, 1.0, 0.01) var mountain_e_min: float = 0.85
