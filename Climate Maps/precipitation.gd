...
@export var auto_update := false:
	set(value):
		auto_update = value
		if auto_update and Data.precipitation_perlin:
			Data.precipitation_perlin.changed.connect(_update_maps)
		elif Data.precipitation_perlin:
			Data.precipitation_perlin.changed.disconnect(_update_maps)
		
		if auto_update and Data.precipitation_simplex:
			Data.precipitation_simplex.changed.connect(_update_maps)
		elif Data.precipitation_simplex:
			Data.precipitation_simplex.changed.disconnect(_update_maps)
...
func _update_maps():
	...
	simplex_texture.set_noise(Data.precipitation_simplex)
	...
	perlin_texture.set_noise(Data.precipitation_perlin)
