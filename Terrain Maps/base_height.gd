...
@export var auto_update := false:
	set(value):
		auto_update = value
		if auto_update and Data.base_perlin:
			Data.base_perlin.changed.connect(_update_maps)
		elif Data.base_perlin:
			Data.base_perlin.changed.disconnect(_update_maps)
		
		if auto_update and Data.base_simplex:
			Data.base_simplex.changed.connect(_update_maps)
		elif Data.base_simplex:
			Data.base_simplex.changed.disconnect(_update_maps)
...
func _update_maps():
	...
	simplex_texture.set_noise(Data.base_simplex)
	...
	perlin_texture.set_noise(Data.base_perlin)
