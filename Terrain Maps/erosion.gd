...
@export var Data: ElevationData = load("res://Terrain Maps/elevation_data.tres")
...
@export var auto_update := false:
	set(value):
		auto_update = value
		if auto_update and Data.erosion_perlin:
			Data.erosion_perlin.changed.connect(_update_maps)
		elif Data.erosion_perlin:
			Data.erosion_perlin.changed.disconnect(_update_maps)
		
		if auto_update and Data.erosion_simplex:
			Data.erosion_simplex.changed.connect(_update_maps)
		elif Data.erosion_simplex:
			Data.erosion_simplex.changed.disconnect(_update_maps)
...
func _update_maps():
	...
	simplex_texture.set_noise(Data.erosion_simplex)
	...
	perlin_texture.set_noise(Data.erosion_perlin)
